...
import { USER_QUERY, USERS_QUERY, UPDATE_USER_MUTATION } from './tags'
...
export const usersQuery = async (): Promise<{ users: NexusGenObjects['User'][] }> => {
  return await graphQLClient.request(USERS_QUERY)
}
